-- Admin bootstrap function (call from service context or edge function)
-- This creates a secure way to set up the initial admin
...
BEGIN
  ...
  -- Create new user using auth schema
...
-- Grant execute to service_role only (for edge functions)
