...
REVOKE ALL ON FUNCTION public.create_investment(uuid, numeric, integer)              FROM PUBLIC, anon;
REVOKE ALL ON FUNCTION public.create_pending_investment(uuid, numeric, text, text)   FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.create_investment(uuid, numeric, integer)            TO authenticated, service_role;
